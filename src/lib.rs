...
impl XWing {
    ...
    pub fn encapsulate<R: Rng + CryptoRng, Pk: AsMut<PublicKey>>(
        ...
        let (ml_kem_cipher, ml_kem_shared_secret) =
            EncapsulationKey::<MlKem768Params>::from_bytes(&pk.ml_kem_public.into())
    ...
    pub fn decapsulate<Ct: AsMut<Ciphertext>, Sk: AsMut<SecretKey>>(
        ...
        let ml_kem_shared_secret =
            DecapsulationKey::<MlKem768Params>::from_bytes(&sk.ml_kem_secret.into())
